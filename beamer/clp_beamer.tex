...
\begin{frame}
  ...
  \begin{minipage}{.49\textwidth}
    \begin{center}
    \only<1>{\includegraphics[width=.5\textwidth]{moniteur-clair.png}}
...
\minitoc
\subsection{Implémenation naïve}j\begin{frame}[containsverbatim]{Implémenation naïve d'un Future minimal en Python}
\begin{lstlisting}
class FutureNaif:
