...
\end{frame}
% \begin{frame}
%   \frametitle{Problème 3: Interblocage, Famine, Inversion de Priorité}
%   \begin{minipage}{.7\textwidth}
...
%       à besoin $\rightarrow$ \textbf{interblocage}
%     \item Une tâche attend indéfiniment une ressouce bloquée $\rightarrow$
%       \textbf{famine}
...
%     \includegraphics[.3\textwidth]{philosophes.png}
%   \end{minipage}
